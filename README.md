...
This project is divided two parts associated with the data preparation and the binary classification models.To have a better visualization of the scripts, I suggest to check them in nbviewer:
